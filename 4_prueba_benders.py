        ...
        for snt_python in snt_list:
            ...
            for s_python in s_list:
                ...
                if iter_python==1 and snt_python=="forward" and s_python==1:
                    ...
                    dataframe_resultados[iter_python][snt_python][s_python]['pd_zkk']=pd.DataFrame(array_zkk,columns=["iter","Value"])
                    ...
                    model_container.write("./gtout.gdx")
