                ...
                for s_python in s_list:
                    ...
                    if iter_python==1:
                        ...
                        if s_python==1:
                            ...
                            #prueba insercion pi_kk
                            pd_pikk=dataframe_resultados[iter_python-1]['backward'][s_python+1]['pd_pikk']
                            #model_container_variable.removeSymbols('x_kk')
                            if 'pi_kk' in model_container_variable.listParameters():
                                model_container_variable.removeSymbols('pi_kk')
                            pi_kk=gt.Parameter(model_container_variable,'pi_kk',[iter,r,t])
                            ...
                            #prueba insercion theta_kk
                            pd_thetakk=dataframe_resultados[iter_python-1]['backward'][s_python]['pd_thetakk']
                            #model_container_variable.removeSymbols('Z_kk')
                            if 'theta_kk' in model_container_variable.listParameters():
                                model_container_variable.removeSymbols('theta_kk')
                            theta_kk=gt.Parameter(model_container_variable,'theta_kk',[iter,s])
                            ...
                            transfer_model = ws.add_job_from_string(gams_source="solve multibenders3 using LP minimizing Z;",
                                                                    checkpoint=check_point)
                            ...
                            #prueba insercion pi_kk
                            if s_python==4:
                                pd_pikk=dataframe_resultados[iter_python-1]['forward'][s_python+1]['pd_pikk']
                            else:
                                pd_pikk=dataframe_resultados[iter_python-1]['backward'][s_python+1]['pd_pikk']
                            if 'pi_kk' in model_container_variable.listParameters():
                                model_container_variable.removeSymbols('pi_kk')
                            ...
                            #prueba insercion theta_kk
                            if s_python==4:
                                pd_thetakk=dataframe_resultados[iter_python-1]['forward'][s_python]['pd_thetakk']
                            else:
                                pd_thetakk=dataframe_resultados[iter_python-1]['backward'][s_python]['pd_thetakk']
                            if 'theta_kk' in model_container_variable.listParameters():
                                model_container_variable.removeSymbols('theta_kk')
                            ...
                            transfer_model = ws.add_job_from_string(gams_source="solve multibenders4a using LP minimizing Z;",
                                                                    checkpoint=check_point)
