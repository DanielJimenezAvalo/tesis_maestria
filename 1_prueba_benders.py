                ...
                for s in s_list:
                    ...
                    if iter==1:
                        ...
                        if s==1:
                            ...
                            print("sentido: "+str(snt))
                            print("stage: "+str(s))

                            k=s
                            ss=k
                            #gamssolve(multibenders1)
