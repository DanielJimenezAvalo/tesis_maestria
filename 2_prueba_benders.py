    ...
    for iter in iter_list:
        ...
        for snt in snt_list:
            ...
            for s in s_list:
                ...
                if iter==1 and snt=="forward" and s==1:
                    
                    iteracion=iter
                    k=s
                    ss=k
                    print("gamssolve(multibenders1)")
                    ...
                    s_mapsp=[]
                    t_mapsp=[]
                    #print(list(t5.out_db["MAPSP"]))
                    #for i in list(t5.out_db["MAPSP"]):
                    #    print(str(i.key(0)))


                    for m in list(t5.out_db["MAPSP"]):
                        if m.key(0)=='1':
                ...
                elif iter==1 and snt=="forward" and (s>1 or s<max(s_list)):
                ...
                elif iter==1 and snt=="forward" and s==max(s_list):
                ...
                elif iter>1 and snt=="forward" and s==1:
                ...
                elif iter>=1 and snt=="backward" and (s>1 and s<max(s_list)):
